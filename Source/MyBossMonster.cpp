...
AMyBossMonster::AMyBossMonster()
{
	...
	(TEXT("/Script/Engine.SkeletalMesh'/Game/SKnight_modular/Skeleton_Knight_06/mesh/SK_SKnight_full_06.SK_SKnight_full_06'"));
...
void AMyBossMonster::RandAreaAttack()
{
	if (_decal)
    {
        ...
        if (World)
        {
            ...
            AMyDecalActor* Decal = World->SpawnActor<AMyDecalActor>(_decal, RandomLocation, FRotator::ZeroRotator, SpawnParams);
        }
    }
}
